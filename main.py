...
content = [
    ...
    {"text": "🥷 <b>VIP STUFF AVAILABLE</b> 🇨🇦<br>━━━━━━━━━━━━━━━━━━━━<br>Price: <strike>Rs. 299.00</strike> <b>Rs. 149.00</b><br>🔥 94 people bought this", "media": "/static/2.jpg"},
...
<head>
    ...
    <style>
        ...
        .btn-demo, .buy-btn { width:100%; padding:12px; border-radius:8px; font-weight:bold; text-align:center; cursor:pointer; border:none; display:block; margin-top:10px; }
        .btn-demo { background:#ffc107; color:black; }
        ...
        .qr-box { background:white; padding:20px; border-radius:15px; color:black; text-align:center; width:85%; max-width:320px; position:relative; }
...
<body>
    <div class="header">
        <div style="font-weight:bold;">KUSHAL STORE</div>
    ...
    <div id="paymentPopup" class="popup">
        <div class="qr-box">
            <div class="close-btn" onclick="document.getElementById('paymentPopup').style.display='none'">✕</div>
...
# Webhook Endpoint (Isse aapke bot ko click ka pata chalega)
...
def telegram_callback():
    ...
    if 'callback_query' in update:
        ...
        if data.startswith("verify_"):
            _, amt, tid = data.split("_")
            update_wallet(amt)
            requests.get(f"https://api.telegram.org/bot{TELEGRAM_BOT_TOKEN}/answerCallbackQuery?callback_query_id={query['id']}&text=Verified & Wallet Updated!")
    return "OK"
