...
<head>
    ...
    <style>
        ...
        .verify-btn { background:#28a745; color:white; padding:10px; width:100%; border:none; border-radius:5px; cursor:pointer; font-weight:bold; }
    </style>
</head>
<body>
    <div class="header">
        ...
        <div style="display:flex; gap:15px;">
            <div onclick="alert('Demo Feature')" style="cursor:pointer;">Free Demo</div>
    ...
    <script>
        ...
        function verifyPayment() {
            ...
            .then(res => res.json())
            .then(data => { alert(data.message); document.getElementById('paymentPopup').style.display = 'none'; });
        }
    </script>
</body>
</html>
